...
Figure [\[fig-eval-pr_curve\]](#fig-eval-pr_curve){reference-type="ref"
reference="fig-eval-pr_curve"} shows precision-recall curves of two
...
Figure [\[fig-eval-roc\]](#fig-eval-roc){reference-type="ref"
reference="fig-eval-roc"} illustrates a plot of an ROC curve, where the
...
in Figure [\[fig-eval-roc\]](#fig-eval-roc){reference-type="ref"
reference="fig-eval-roc"} and is the result of random guessing.
...
their means.
Figure [\[fig-eval-cor\]](#fig-eval-cor){reference-type="ref"
reference="fig-eval-cor"} illustrates the connection using a
...
As shown in
Figure [\[fig-eval-cor\]](#fig-eval-cor){reference-type="ref"
reference="fig-eval-cor"}, the actual values can be regarded as a vector
