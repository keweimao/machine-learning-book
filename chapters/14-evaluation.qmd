...
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-precision)
to turn **Precision** into a calculation,
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-recall)
to turn **Recall** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-sensitivity-and-specificity)
to turn **Sensitivity and Specificity** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-kappa-and-chance-agreement)
to turn **Kappa and Chance Agreement** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-averaging)
to turn **Averaging** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-rank-evaluation)
to turn **Rank Evaluation** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-error-metrics)
to turn **Error Metrics** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-correlation)
to turn **Correlation** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-evaluation-of-numeric-predictions)
to turn **Evaluation of Numeric Predictions** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-experimentation)
to turn **Experimentation** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/14-evaluation-and-experimentation.qmd#sec-pr-14-on-efficiency)
to turn **On Efficiency** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
