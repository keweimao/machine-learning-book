...
![Shannon entropy of two mutually exclusive events.](../assets/figures/chapter05/fig-info-h){#fig-info-h fig-alt="Entropy curve peaking when two outcomes each have probability one half." width="55%"}

@fig-info-h shows that the entropy function is smooth with
...
![Shannon entropy of $m$ equally likely events.](../assets/figures/chapter05/fig-info-h-m){#fig-info-h-m fig-alt="Increasing logarithmic curve showing entropy as the number of equally likely outcomes grows." width="55%"}

@fig-info-h-m plots entropy $H$ vs. the number of equally
...
Continue with [the corresponding practice activity](../practice/05-information-entropy-and-divergence.qmd#sec-pr-05-properties-of-shannon-entropy)
to turn **Properties of Shannon Entropy** into a calculation,
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/05-information-entropy-and-divergence.qmd#sec-pr-05-entropy-in-thermodynamics)
to turn **Entropy in Thermodynamics?** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/05-information-entropy-and-divergence.qmd#sec-pr-05-applications)
to turn **Applications** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/05-information-entropy-and-divergence.qmd#sec-pr-05-shannon-entropy)
to turn **Shannon Entropy** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
third. This can be illustrated in @fig-info-triangle, where any two distances (sides)
$d(A,B) + d(B,C) \ge d(A,C)$.

![Triangle inequality: the sum of two distances is never less than the third, $d(A,B) + d(B,C) \ge d(A,C)$.](../assets/figures/chapter05/fig-info-triangle){#fig-info-triangle fig-alt="Triangle with vertices A, B, and C and labeled distances between them." width="50%"}
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/05-information-entropy-and-divergence.qmd#sec-pr-05-relative-entropy)
to turn **Relative Entropy** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/05-information-entropy-and-divergence.qmd#sec-pr-05-limits-and-other-measures)
to turn **Limits and Other Measures** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/05-information-entropy-and-divergence.qmd#sec-pr-05-jensen-shannon-divergence)
to turn **Jensen-Shannon Divergence** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/05-information-entropy-and-divergence.qmd#sec-pr-05-idf-and-kl-divergence)
to turn **IDF and KL Divergence** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
...
@fig-info-lit compares least information (LIT) with Shannon
...
illustrated in @fig-info-dist-add, where $a+b=c$. This is the only
situation in which they are equal with the triangle inequality.

![Sum of distances in the same direction, $a+b=c$.](../assets/figures/chapter05/fig-info-dist-add){#fig-info-dist-add fig-alt="Three collinear points with adjacent distances a and b summing to total distance c." width="55%"}
...
<!-- practice-link:start -->
::: {.callout-tip collapse="true" title="Put it into practice"}
Continue with [the corresponding practice activity](../practice/05-information-entropy-and-divergence.qmd#sec-pr-05-least-information-theory-lit)
to turn **Least Information Theory (LIT)** into a calculation,
implementation, visualization, diagnostic, or interpretation task.
:::
<!-- practice-link:end -->
