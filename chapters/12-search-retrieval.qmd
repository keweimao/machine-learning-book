...
As shown in Figure [1.1](#fig-ir){reference-type="ref"
reference="fig-ir"}, the user with an information need issues a query to
...
<figure id="fig-ir" data-latex-placement="!htb">
<embed src="../assets/figures/ir2.png" style="width:3.5in" />
<figcaption>Basic paradigm of an <span><em>Information
Retrieval</em></span> system</figcaption>
</figure>
...
Figure [1.1](#fig-ir){reference-type="ref" reference="fig-ir"} and walk
through some of the major ideas for finding matched (and potentially
relevant) documents.

In Figure [1.1](#fig-ir){reference-type="ref" reference="fig-ir"}, the
...
<figure id="fig-ir-postings">

<figcaption>Two postings from the inverted index. Highlighted document
IDs with double border indicate matched documents that satisfy
<span><em>Declaration</em></span> AND
<span><em>Independence</em></span>. </figcaption>
</figure>
...
documents $\#2$, $\#103$, and $\#456$ in Figure
 [1.2](#fig-ir-postings){reference-type="ref"
reference="fig-ir-postings"} contain both terms. But how can an
...
shown in Figure [1.3](#fig-ir-matching){reference-type="ref"
reference="fig-ir-matching"}, where the *Declaration* posting has a
...
<tr>
<td style="text-align: left;"><span>Step 1</span></td>
<td style="text-align: left;"><span>Step 2</span></td>
<td style="text-align: left;"><span>Step 3</span></td>
</tr>
</tbody>
</table>
<figcaption>Simultaneous walking to merge postings, starting at the
first document ID. The posting with the smaller value will move to the
next ID. </figcaption>
</figure>
...
Figure [1.3](#fig-ir-matching){reference-type="ref"
reference="fig-ir-matching"} step 3, then goes to document $\#3$ and
...
Figure [\[fig-hlinks\]](#fig-hlinks){reference-type="ref"
reference="fig-hlinks"} shows an example of a web page, from which the
user can click on a label (text), a button, or an image to visit another
page.

::: marginfigure
![image](../assets/figures/pageflow2.png){width="2in"}
:::
...
In Figure [\[fig-hlinks\]](#fig-hlinks){reference-type="ref"
reference="fig-hlinks"}, when page A links to page B, descriptions or
...
Figure [\[fig-ir-2links\]](#fig-ir-2links){reference-type="ref"
reference="fig-ir-2links"}, for example, page $t$ has two in-links from
pages $p_1$ and $p_2$ and its impact score is therefore $2$.

::: marginfigure
![image](../assets/figures/ir/ir_2links.png){width="1.5in"}
:::

But are all hyperlinks created equal? Let's consider an extreme case
where we have more data for the two linking pages in
Figure [\[fig-ir-2links\]](#fig-ir-2links){reference-type="ref"
reference="fig-ir-2links"}. Suppose $p_1$ is an ordinary page that is
...
Figure [1.4](#fig-ir-2links_more){reference-type="ref"
reference="fig-ir-2links_more"} illustrates this scenario.
...
Figure [1.4](#fig-ir-2links_more){reference-type="ref"
reference="fig-ir-2links_more"}, the impact of document $d$ depends on
