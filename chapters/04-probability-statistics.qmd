...
::: marginfigure
  ------------------------------------------------ ------------------------------------------------
   ![image](../assets/figures/prob/coin_head.png){width="1in"}   ![image](../assets/figures/prob/coin_tail.png){width="1in"}
  ------------------------------------------------ ------------------------------------------------
:::
...
::: marginfigure
![image](../assets/figures/prob/p_no_overlap.png){width="2in"}
:::
...
Figure [\[fig-prob-no_overlap\]](#fig-prob-no_overlap){reference-type="ref"
reference="fig-prob-no_overlap"}, have *no overlap* or intersection in
...
::: marginfigure
![image](../assets/figures/prob/p_overlap.png){width="2in"}
:::

The reason for subtracting the joint probability $P(A \cap B)$ can be
illustrated in
Figure [\[fig-prob-overlap\]](#fig-prob-overlap){reference-type="ref"
reference="fig-prob-overlap"}. As shown in the figure, when A and B can
...
::: marginfigure
![image](../assets/figures/prob/ace_spades.png){width="2in"}
:::
...
shows (Figure [1.1](#fig-prob-elephant){reference-type="ref"
reference="fig-prob-elephant"}). But we should aim to see the whole
picture.
...
<figure id="fig-prob-coin_freq">

<figcaption>Frequency distribution of flipping a coin, 500 heads vs. 500
tails after <span class="math inline">1, 000</span> trials in the ideal
world. </figcaption>
</figure>
...
<figure id="fig-prob-coin_prob">

<figcaption>Probability distribution of flipping a coin (500 heads vs.
500 tails). </figcaption>
</figure>
...
distribution, as Figure [1.3](#fig-prob-coin_prob){reference-type="ref"
reference="fig-prob-coin_prob"} shows.
...
Figure [1.4](#fig-prob-dice){reference-type="ref"
reference="fig-prob-dice"}.

<figure id="fig-prob-dice">

<figcaption>Probability distribution of rolling a dice</figcaption>
</figure>
...
it remains a flat line in the range of 1 - 6, shown in
Figure [1.5](#fig-prob-cont){reference-type="ref"
reference="fig-prob-cont"}.

<figure id="fig-prob-cont">

<figcaption>Probability distribution of a continuous variable <span
...
Figure [1.5](#fig-prob-cont){reference-type="ref"
reference="fig-prob-cont"} and it is easy to calculate the area. In the
...
Figure [1.5](#fig-prob-cont){reference-type="ref"
reference="fig-prob-cont"} is NOT a probability value per se. It is what
...
<figure id="fig-prob-height">

<figcaption>Distribution of adult male heights, approximately a normal
distribution (bell curve)</figcaption>
</figure>
...
Figure [1.5](#fig-prob-cont){reference-type="ref"
reference="fig-prob-cont"}, the $0.2$ value on y is not probability but
...
Figure [1.5](#fig-prob-cont){reference-type="ref"
reference="fig-prob-cont"}, the answer is that it will *always be true*.
...
Figure [1.7](#fig-prob-word_freq){reference-type="ref"
reference="fig-prob-word_freq"} shows the distribution of word
frequencies taken from the novel *Moby Dick*. As shown in
Figure [1.7](#fig-prob-word_freq){reference-type="ref"
reference="fig-prob-word_freq"} (a), there is a great divide between the
...
The result is Figure [1.7](#fig-prob-word_freq){reference-type="ref"
reference="fig-prob-word_freq"} (b), where both $x$ (words' occurrences)
and $y$ (frequencies of the occurrences) have been transformed with
logarithm.[^ch04-7]

<figure id="fig-prob-word_freq">
<table>
<tbody>
<tr>
<td style="text-align: center;"><img src="../assets/figures/prob/word_freq.png"
style="width:2in" alt="image" /></td>
<td style="text-align: center;"><img src="../assets/figures/prob/word_freq_log.png"
style="width:2in" alt="image" /></td>
</tr>
<tr>
...
<figcaption>Word frequency distribution</figcaption>
</figure>
