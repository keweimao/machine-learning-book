...
| II | 9A | Convolutional Neural Networks: Learning Spatial Structure | 95% | Complete conceptual progression; worked kernel math; shapes, channels, pooling, parameter counts; executed MLP/CNN practicum with learning curves and 1-versus-7 feature maps | Incorporate student feedback; decide whether augmentation and transfer learning need an optional extension |
