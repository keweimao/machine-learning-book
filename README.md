...
6. Follow `planning/PUBLISHER_STRATEGY.md` to qualify Cambridge's open-web terms,
   assemble the proposal and samples, and approach MIT Press or other fallbacks if
   needed.
